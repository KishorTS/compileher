...
// });
    ...
    $('#next2').click(function()
	{
        ...
        if (radioValue=="compile time error") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next5').click(function()
	{
        ...
        if (radioValue=="cannot point to the index") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next6').click(function()
	{
        ...
        if (radioValue=="undefined function used") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next9').click(function()
	{
        ...
        if (radioValue=="undefined variable") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next10').click(function()
	{
        ...
        if (radioValue=="none of the mentioned") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next12').click(function()
	{
        ...
        if (radioValue=="error:Positive Number Required") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next13').click(function()
	{
        ...
        if (radioValue=="prints first 19 numbers and throws exception at 20") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next14').click(function()
	{
        ...
        if (radioValue=="Depends on the size of data type") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next15').click(function()
	{
        ...
        if (radioValue=="abnormal program termination") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next16').click(function()
	{
        ...
        if (radioValue=="ADDRESS, ADDRESS, 3") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next17').click(function()
	{
        ...
        if (radioValue=="Error: we may not get input for second scanf() statement") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next18').click(function()
	{
        ...
        if (radioValue=="Output: Unable to open file") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next19').click(function()
	{
        ...
        if (radioValue=="Error: in unsigned char declaration") 
            {
                score=score+1;
            }
            if (radioValue!=null)
    ...
    $('#next20').click(function()
	{
        ...
        if (radioValue=="Error: fseek() long offset value") 
            {
                score=score+1;
            }
            if (radioValue!=null)
