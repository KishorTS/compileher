$(document).ready(function()
{
    ...
    $('#next3').click(function()
	{
        ...
        if (radioValue=="Depends on the memory") 
	        {
	        	score=score+1;	
	        }
	        if (radioValue!=null)
